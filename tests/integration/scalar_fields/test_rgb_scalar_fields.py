...
@pytest.mark.parametrize("scalar_field", ["hsv", "relative_luminance", "rgb_intensity"])
...
def test_relative_luminance_bounds(pyntcloud_with_rgb_and_normals):
    pyntcloud_with_rgb_and_normals.add_scalar_field("relative_luminance")
...
def test_rgb_intensity_bounds(pyntcloud_with_rgb_and_normals):
    pyntcloud_with_rgb_and_normals.add_scalar_field("rgb_intensity")
