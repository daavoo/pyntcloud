...
from ..geometry.coord_systems import cartesian_to_spherical, cartesian_to_cylindrical
...
class PlaneFit(XYZScalarField):
    ...
    def __init__(
        self, *, pyntcloud, max_dist=1e-4, max_iterations=100, n_inliers_to_stop=None
    ):
